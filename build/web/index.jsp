    ...
    <head>
        ...
        <style>
             a.position-relative {
                ...
                font-size: 1rem; /* Reduced size of the icon */
                position: relative; /* Ensure the relative positioning for absolute child positioning */
            }
            .cart-size-badge {
                position: absolute; /* Ensure it positions relative to the parent */
                transform: translate(75%, -50%); /* Adjusted to shift the badge slightly more to the right */
                top: 0; /* Adjust the top position to move badge up */
                right: -0.5em; /* Adjust the right position to move badge further to the right */
                padding: 0.1em 0.3em; /* Adjusted smaller padding for a neater look */
                font-size: 0.65rem; /* Smaller font size for the text inside the badge */
                background-color: #ff0000; /* Bright red background for visibility */
                border: 1px solid white; /* Reduced border size to make it less pronounced */
                color: white; /* White text color */
                border-radius: 50%; /* Adjusted to make the badge perfectly circular */
                display: flex; /* Center the number vertically and horizontally */
                align-items: center;
                justify-content: center;
                min-width: 1.5em; /* Adjusted minimum width to ensure badge is visible and proportional */
                height: 1.5em; /* Adjusted height to maintain circular shape */
            }
            ...
            <nav class="container fixed-top" style="background-color:#7b88a8; border-radius:16px;">
                <div class="row d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-lg-3 col-7 align-items-center">
                        <form action="SearchProductServlet" method="get" class="d-flex align-items-center">
                            <input type="hidden" name="search" value="true" />
                            <input class="w-75 form-control rounded-pill bg-light" type="text" name="txtSearch" placeholder="Search" />
                    ...
                    <div class="col-lg-3 align-items-center  clickClose" style="display: <%= yeslogin%>;">
                        <a href="<%=request.getContextPath()%>/cart" class="text-white ms-5 me-3 position-relative">
                            <i class="bi bi-cart2"></i>
                            <span class="cart-size-badge position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">${sessionScope.cartSize}</span>
                        </a>
                        <div class="btn-group">
                ...
                <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="https://img.freepik.com/free-photo/tied-up-paper-with-string-pink-flowers-leaves-concrete-background_
                                 23-2147942354.jpg?t=st=1717526153~exp=1717529753~hmac=5462b2bca2ce7e5846276d65d7650c3d7513c20acf65b7ac23d62984bbdbba27&w=1380" class="d-block w-100" alt="Slide 2">
                        </div>
                        <div class="carousel-item">
