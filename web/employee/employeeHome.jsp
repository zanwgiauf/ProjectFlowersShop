            ...
            <div class="row">
                <nav id="sidebar" class="col-md-2 d-none d-md-block sidebar" style="background-color: #7b88a8">
                    <div class="container sidebar-sticky text-decoration-none">
                        <a href="<%=request.getContextPath()%>/EmployeeController" class="fs-4 fw-bold d-flex justify-content-center align-items-center text-dark">
                        ...
                        <ul class="nav flex-column mt-3">
                            <li class="nav-item">
                                <a class="nav-link active" href="<%=request.getContextPath()%>/EmployeeController">
                        ...
                        <form action="LogoutController" method="post" class="mt-5 me-2" style="border-radius: 16px">
