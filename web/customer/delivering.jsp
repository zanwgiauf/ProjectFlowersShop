...
<html>
    ...
    <body>
        ...
        <div class="container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                         <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="<%= request.getContextPath() %>/order/delivering" class="nav-link btn btn-link active fw-bold">Delivering</a>
                            </li>
                            <li class="nav-item">
            ...
            <h2 class="text-center text-info my-5">Delivering Orders</h2>
            <div class="table-responsive">
                <c:if test="${empty deliveringOrders}">
                    <div class="alert alert-info text-center" role="alert">
                        No items in delivering orders.
                    </div>
                </c:if>
                <c:if test="${not empty deliveringOrders}">
                    <table class="table  text-center">
                        ...
                        <tbody>
                            <c:forEach var="orderDetail" items="${deliveringOrders}">
                                <tr>
