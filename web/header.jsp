...
<html>
    <head>
        ...
        <style>
            /* Style for the cart icon wrapper */
            a.position-relative {
    ...
    <body>
        ...
        %>
    <c:set var="cartSize" value="${sessionScope.cartSize}" default="0" />
...
//                    int count = ctDAO.getCountCartByCusID(cus_id);
                ...
                <div class="col-lg-3 align-items-center  clickClose" style="display: <%= yeslogin%>;">
                    <a href="<%=request.getContextPath()%>/cart" class="text-white ms-5 me-3 position-relative">
                        ...
                        <span class="cart-size-badge position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">${cartSize}</span>
                    </a>
