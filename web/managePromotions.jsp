    ...
    <body>
                        ...
                        <form action="promotions" method="post" id="addPromotionForm" onsubmit="return validatePromotionForm()">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="discount" id="discount" min="0" required>
                                        <span class="input-group-text">%</span>
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <script>
            ...
            function validatePromotionForm() {
                const discount = document.getElementById('discount').value; // Lấy giá trị discount từ form
                const startDate = new Date(document.getElementById('startDate').value);
                const endDate = new Date(document.getElementById('endDate').value);

                if (discount < 0) {
                    alert('Discount cannot be negative. Please enter a valid discount value.');
                    return false; // Prevent form submission if discount is negative
                }

                if (endDate <= startDate) {
                    alert('End date must be after start date. Please enter a valid end date.');
                    return false; // Prevent form submission if end date is before start date
                }
