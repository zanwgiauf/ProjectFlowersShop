                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-lg">
                            ...
                            <tbody>
                                ...
                                <div class="modal fade" id="edit${e.getEmployeeID()}" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="employeeFormEdit${e.getEmployeeID()}" action="${pageContext.request.contextPath}/admin/employee-management" method="post" onsubmit="return validateEditForm(${e.getEmployeeID()})">
                                                    <label style="margin-bottom: 10px" for="nameEdit${e.getEmployeeID()}">Employee name</label><br>
                                                    <input class="input-group" type="text" name="name" value="${e.getFullName()}" id="nameEdit${e.getEmployeeID()}" placeholder="Enter Employee name">
                                                    <div id="nameEditError${e.getEmployeeID()}" class="text-danger"></div><br>

                                                    <label style="margin-bottom: 10px" for="phoneEdit${e.getEmployeeID()}">Phone</label><br>
                                                    <input class="input-group" type="text" name="phone" value="${e.getPhone()}" id="phoneEdit${e.getEmployeeID()}" placeholder="Enter phone number">
                                                    <div id="phoneEditError${e.getEmployeeID()}" class="text-danger"></div><br>

                                                    <label style="margin-bottom: 10px" for="emailEdit${e.getEmployeeID()}">Email</label><br>
                                                    <input class="input-group" type="email" name="email" value="${e.getEmail()}" id="emailEdit${e.getEmployeeID()}" placeholder="Enter email">
                                                    <div id="emailEditError${e.getEmployeeID()}" class="text-danger"></div><br>

                                                    <input type="hidden" name="action" value="edit"><br>
                                                    <input type="hidden" name="id" value="${e.getEmployeeID()}"><br>
