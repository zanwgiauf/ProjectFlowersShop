...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    <nav id="sidebar" class="col-md-3 d-none d-md-flex sidebar" style="width: 300px; background-color: #7b88a8;">
                        <div class="container sidebar-sticky text-decoration-none text-white">
                            ...
                            <ul class="nav flex-column mt-3">
                                ...
                                <li class="nav-item">
                                    <a href="<%= request.getContextPath() %>/adminproducts" class="nav-link text-white"><i class="bi bi-box"></i> Manage Product </a> 
                                    </a>
                                </li>
                                ...
                                <c:forEach var="product" items="${products}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="${pageContext.request.contextPath}/admin/adminproducts" method="post" style="display:inline;" onsubmit="return confirmDelete();">
